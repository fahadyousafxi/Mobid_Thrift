...
class MoreAccessories extends StatefulWidget {
  const MoreAccessories({Key? key}) : super(key: key);

  @override
  State<MoreAccessories> createState() => _MoreAccessoriesState();
}

class _MoreAccessoriesState extends State<MoreAccessories> {
  ...
  void initState() {
    ...
    productProvider.fitchAccessoriesProducts();
    super.initState();
  }
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 8,),
            Expanded(
              child: GridView.builder(itemCount: productProvider.getAccessoriesProductsList.length, gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(crossAxisCount: 2, mainAxisSpacing: 10, crossAxisSpacing: 10, childAspectRatio: 2/2.4), itemBuilder: (context, index) {
