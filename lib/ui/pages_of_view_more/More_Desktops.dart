...
class MoreDesktops extends StatefulWidget {
  const MoreDesktops({Key? key}) : super(key: key);

  @override
  State<MoreDesktops> createState() => _MoreDesktopsState();
}

class _MoreDesktopsState extends State<MoreDesktops> {
  ...
  void initState() {
    ...
    productProvider.fitchDesktopsProducts();
    super.initState();
  }
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 8,),
            Expanded(
              child: GridView.builder(itemCount: productProvider.getDesktopsProductsList.length, gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(crossAxisCount: 2, mainAxisSpacing: 10, crossAxisSpacing: 10, childAspectRatio: 2/2.4), itemBuilder: (context, index) {
