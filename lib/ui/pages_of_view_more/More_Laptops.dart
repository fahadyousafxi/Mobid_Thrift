...
class MoreLaptops extends StatefulWidget {
  const MoreLaptops({Key? key}) : super(key: key);

  @override
  State<MoreLaptops> createState() => _MoreLaptopsState();
}
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 8,),
            Expanded(
              child: GridView.builder(itemCount: productProvider.getLaptopsProductsList.length, gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(crossAxisCount: 2, mainAxisSpacing: 10, crossAxisSpacing: 10, childAspectRatio: 2/2.4), itemBuilder: (context, index) {
