      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 8,),
            Expanded(
              child: GridView.builder(itemCount: cellPhonesProductProvider.getSmartWatchesProductsList.length, gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(crossAxisCount: 2, mainAxisSpacing: 10, crossAxisSpacing: 10, childAspectRatio: 2/2.4), itemBuilder: (context, index) {

                var data = cellPhonesProductProvider.getSmartWatchesProductsList[index];
                return Card(
