...
import 'package:mobidthrift/ui/shipping/report_page.dart';
import 'package:provider/provider.dart';

import '../../utils/utils.dart';
import '../Seller_Profile.dart';

class ToBeReported extends StatefulWidget {
  const ToBeReported({Key? key}) : super(key: key);

  @override
  State<ToBeReported> createState() => _ToBeReportedState();
}

class _ToBeReportedState extends State<ToBeReported> {
